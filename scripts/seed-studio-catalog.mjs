...
const cliffsideCoastPoseTemplates = [
  { slug: "coastal-overlook", name: "Над бухтой Лама-Монакиле", camera: "объектив 70 мм, уровень глаз", pose: "стоит у прочного каменного парапета на широкой смотровой площадке", prompt: "standing on a broad belvedere behind a solid limestone parapet, iconic Lama Monachile pebble cove, historic bridge and turquoise Adriatic clearly visible" },
  { slug: "windswept-path", name: "В улочке старого города", camera: "объектив 50 мм, репортажный ракурс", pose: "идёт по спокойной светлой улочке, естественный шаг", prompt: "walking through a narrow white-limestone old-town alley, arched passage, pale paving and a framed glimpse of the Adriatic, authentic Polignano a Mare" },
  { slug: "rock-wall", name: "Под белой аркой", camera: "объектив 85 мм, мягкая глубина", pose: "стоит в светлом каменном проёме, корпус слегка повернут", prompt: "three-quarter portrait beneath a whitewashed limestone arch, blue sea and old-town textures softly layered behind" },
  { slug: "ocean-profile", name: "На террасе над морем", camera: "объектив 70 мм, мягкий боковой свет", pose: "полуоборот на просторной морской террасе за сплошным парапетом", prompt: "half-turn on a spacious sea-view terrace behind a solid parapet, turquoise Adriatic and limestone sea caves behind, refined Italian coastal mood" },
  { slug: "stone-seat", name: "У исторического моста", camera: "объектив 70 мм, архитектурный ракурс", pose: "стоит на широкой пешеходной части моста, руки видны", prompt: "standing on the broad pedestrian viewpoint by the historic Lama Monachile bridge, cove and white cliff town creating architectural depth" },
  { slug: "grass-foreground", name: "У бухты с белой галькой", camera: "объектив 85 мм, отражённый морской свет", pose: "стоит на устойчивой площадке у бухты, расслабленная поза", prompt: "portrait on stable ground beside Lama Monachile white-pebble cove, turquoise water and tall limestone walls, elegant Mediterranean light" },
  { slug: "storm-light", name: "На каменных ступенях", camera: "объектив 70 мм, спокойный нижний ракурс", pose: "стоит или сидит на широких светлых ступенях, руки видны", prompt: "standing or seated on broad pale limestone steps in Polignano old town, white facades, restrained plants and a narrow sea glimpse" },
  { slug: "coastal-walk", name: "На приморской набережной", camera: "объектив 50 мм, динамичный editorial-ракурс", pose: "идёт по ровной набережной параллельно морю", prompt: "walking along a level Polignano coastal promenade, white cliff houses and open Adriatic behind, natural polished Italian movement" },
  { slug: "wide-coast", name: "Широкий кадр Полиньяно", camera: "широкий объектив 35 мм", pose: "стоит небольшим силуэтом на просторной безопасной площадке", prompt: "wide environmental Polignano a Mare portrait, person small on a broad safe overlook, white cliff town, honey limestone, sea caves and turquoise Adriatic dominate" },
  { slug: "coast-hero", name: "Главный кадр Полиньяно-а-Маре", camera: "лучший Mediterranean editorial-ракурс, объектив 70 мм", pose: "финальная уверенная поза на широкой террасе старого города", prompt: "signature Polignano a Mare editorial portrait on a spacious old-town terrace, white limestone city and luminous Adriatic coast, polished final Italian lifestyle image" },
];
...
const moscowCityPoseTemplates = [
  { slug: "skyscraper-lobby", name: "Лобби небоскрёба", camera: "объектив 70 мм, уровень глаз", pose: "стоит в стеклянном бизнес-лобби, корпус слегка повернут", prompt: "standing inside a Moscow City skyscraper lobby with marble reflections, tall glass walls, visible Federation Tower style geometry outside, premium business mood, no readable signs or logos" },
  { slug: "tower-street", name: "Между башнями Москва-Сити", camera: "объектив 70 мм, вертикальная перспектива", pose: "стоит на пешеходной площади между башнями", prompt: "standing on a pedestrian plaza between real Moscow City skyscrapers, Federation Tower twin glass towers, Evolution Tower spiral silhouette and OKO-style glass facades rising above, not generic towers" },
  { slug: "river-embankment", name: "Пресненская набережная", camera: "объектив 85 мм, мягкая глубина", pose: "полуоборот у набережной, skyline за спиной", prompt: "half-turn on Presnenskaya embankment with recognizable Moscow City skyline behind, river railings, Bagration bridge feeling, elegant city lifestyle portrait" },
  { slug: "rooftop-terrace", name: "Терраса с башнями", camera: "объектив 70 мм, вечерний свет", pose: "стоит на террасе с видом на башни", prompt: "on a terrace inside the Moscow City complex overlooking Federation Tower, OKO and Neva Towers, dusk light, refined business-lifestyle atmosphere" },
  { slug: "night-skyline", name: "Вечерний skyline", camera: "объектив 85 мм, городские огни", pose: "стоит на фоне вечерних башен", prompt: "portrait against Moscow City night skyline lights and Moscow River reflections, recognizable skyscraper silhouettes, cinematic modern business district mood" },
  { slug: "skyline-lounge", name: "Lounge с видом", camera: "объектив 70 мм, интерьерный свет", pose: "сидит или стоит в lounge-зоне у панорамного окна", prompt: "in a premium skyline lounge with floor-to-ceiling windows looking directly at Moscow City towers, warm interior light, real Moscow business district context" },
  { slug: "glass-promenade", name: "Стеклянный переход", camera: "широкий объектив 35 мм", pose: "идёт по стеклянному переходу, естественный шаг", prompt: "walking through a glass pedestrian passage inside Moscow City between skyscrapers, Afimall-style atrium reflections, tower bases visible, modern urban movement" },
  { slug: "wide-city", name: "Панорама Москва-Сити", camera: "широкий объектив 35 мм", pose: "стоит небольшим силуэтом на фоне панорамы", prompt: "wide environmental shot of the real Moscow City skyline from the river, Federation Tower, Evolution Tower and OKO visible, person smaller in frame, towers and river dominate" },
  { slug: "reflective-facade", name: "У стеклянного фасада", camera: "объектив 85 мм, боковой свет", pose: "полуоборот у стеклянного фасада", prompt: "half-turn beside a reflective Moscow City glass facade, tower reflections, clean business editorial geometry, skyscraper bases around" },
  { slug: "city-hero", name: "Главный business кадр", camera: "лучший urban editorial-ракурс, объектив 70 мм", pose: "финальная уверенная поза в Москва-Сити", prompt: "signature Moscow City premium business portrait inside the complex, recognizable Federation Tower and Evolution Tower context, glass towers, polished skyline, confident modern editorial final image" },
];
...
const modernGorkyParkPoseTemplates = [
  { slug: "modern-entrance", name: "Современный вход", camera: "объектив 70 мм, уровень глаз", pose: "стоит у современного входа в парк без надписей", prompt: "standing near a modern urban park entrance with clean stone and dark metal details, no readable signs or logos" },
  ...
  { slug: "park-hero", name: "Главный park lifestyle кадр", camera: "лучший lifestyle-ракурс, объектив 70 мм", pose: "финальная расслабленная поза в современном парке", prompt: "signature modern urban park lifestyle portrait, renovated promenade, greenery, warm city leisure mood, polished final image" },
];
