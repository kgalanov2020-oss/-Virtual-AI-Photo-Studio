...
const studioTranslations: Record<string, Pick<Studio, "name" | "description">> = {
  ...
  "moscow-city": {
    name: "Москва-Сити",
    description:
      "Современный деловой район: стеклянные башни, набережная, rooftop-террасы, бизнес-lounge и вечерний skyline для премиальной urban-серии.",
  },
  "vorobyovy-msu": {
  ...
  "modern-gorky-park": {
    name: "Современный Парк Горького",
    description:
      "Современный Парк Горького: обновлённые аллеи, набережная, кафе-террасы, павильоны, фонтаны и чистая lifestyle-атмосфера центра Москвы.",
  },
  "gum-moscow": {
    name: "ГУМ Москва",
    description:
